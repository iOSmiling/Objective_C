//
//  XMURLSessionWrapperOperation.m
//  OC
//
...
@interface XMURLSessionWrapperOperation () {
...
@implementation XMURLSessionWrapperOperation

+ (instancetype)operationWithURLSessionTask:(NSURLSessionTask*)task
{
    XMURLSessionWrapperOperation* operation = [XMURLSessionWrapperOperation new];
    operation.task = task;
    return operation;
}
