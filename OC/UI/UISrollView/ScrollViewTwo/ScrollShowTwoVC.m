...
@interface ScrollShowTwoVC () <ZXMovieBrowserDelegate>
...
@implementation ScrollShowTwoVC
...
- (void)setupSubviews
{
    ...
    ZXMovieBrowser *movieBrowser = [[ZXMovieBrowser alloc] initWithFrame:CGRectMake(0, 20, kScreenWidth, kMovieBrowserHeight) movies:self.movies currentIndex:1];
