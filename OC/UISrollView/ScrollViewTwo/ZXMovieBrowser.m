...
#define kItemWidth  180.0
#define kItemHeight 400
#define kItemSelectedWidth  180
#define kItemSelectedHeight 430
...
- (void)setupScrollView
{
    ...
    _scrollView.contentSize = CGSizeMake((kItemWidth + kItemSpacing) * self.movies.count + kItemSpacing, kMovieBrowserHeight-20);
    ...
    for (ZXMovie *movie in self.movies)
    {
        ...
        UIView *itemView = [[UIView alloc] initWithFrame:CGRectMake((kItemSpacing + kItemWidth) * i + kItemSpacing, kMovieBrowserHeight - kItemHeight-50, kItemWidth, kItemHeight)];
