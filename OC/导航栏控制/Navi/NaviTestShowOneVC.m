...
@interface NaviTestShowOneVC ()<NavHeadTitleViewDelegate,headLineDelegate,UITableViewDataSource,UITableViewDelegate>
{
    //头像
...
@implementation NaviTestShowOneVC
...
- (void)viewWillAppear:(BOOL)animated
{
    ...
    self.navigationController.navigationBarHidden = YES;//隐藏系统导航栏
